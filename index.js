...
client.on('messageCreate', async message => {
  if (message.content.startsWith(prefix + `stock`)) {
    ...
    const embed = new MessageEmbed()
      ...
      .setImage('')
      .setColor('#00000'); // يمكنك تغيير لون الإيمبد حسب احتياجك
...
client.on(`interactionCreate` , interaction => {
  ...
  if (interaction.commandName == 'setup'){
   ...
   const Channel = interaction.guild.channels.cache.get(channel); 
    const embed = new MessageEmbed()
    .setDescription('لشراء اعضاء يجب عليك فتح تكت اولا')
.setImage('https://media.discordapp.net/attachments/1199681159379030016/1205085622117867570/B4BA3E9E-7375-4FE8-BE1E-8D46A924F0B9.jpg?ex=65d71671&is=65c4a171&hm=000d16fd0ac451aa47fd1a688602c02b66d3d2eaca1db44bf9a5448ff1856286&=&format=webp&width=1662&height=935')
    ...
    const row = new MessageActionRow().addComponents(
      ...
      .setLabel('Order')
      .setStyle('SUCCESS')
      .setEmoji('<:pp601:1092891736986107998>'), 

      new MessageButton()
          .setLabel('Add')
          .setStyle('LINK')
      .setURL(config.bot.inviteBotUrl)
    .setEmoji('<:emoji_19:1151317195561893899>')
      );
